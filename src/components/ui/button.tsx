...
const buttonVariants = cva(
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold outline-none transition-all duration-150 active:scale-[0.98] active:opacity-70 disabled:pointer-events-none disabled:opacity-50 focus-visible:border-[var(--ring)] focus-visible:shadow-[var(--focus-shadow)] [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
